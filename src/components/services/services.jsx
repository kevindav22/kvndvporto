...
const Services = () => {
  return (
    <section className="bg-[#0e1e32] text-white px-6 md:px-20 py-12 overflow-hidden">
      {/* Judul Section */}
      <div className="text-center" data-aos="fade-up">
        <h3 className="text-xs md:text-sm uppercase tracking-wide text-gray-400">What Do I Offer</h3>
        <h2 className="mt-2 text-2xl md:text-3xl font-semibold leading-snug text-[#C4A77D]">
      ...
      {/* Grid Layanan */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10 mx-auto max-w-7xl">
        {services.map((service, index) => (
          <div key={index} className="bg-white/10 border border-[#C4A77D] rounded-lg p-6 md:p-8 flex flex-col items-center text-center md:text-justify" data-aos="zoom-in" data-aos-delay={index * 200}>
            ...
            <h3 className="text-lg md:text-xl font-semibold text-[#C4A77D] leading-snug">{service.title}</h3>
